(function (globalScope, factory) {
  ...
  function createLoginNoticeTableActionController({
    ...
    const templateTableActionController = createTemplateEditorTableActionController({
      ...
      getTemplateEditorBorderColorInput: getLoginNoticeBorderColorElement,
      getTemplateEditorBorderStyleInput: getLoginNoticeBorderStyleElement,
      getTemplateEditorBorderTargetInput: getLoginNoticeBorderTargetElement,
      getTemplateEditorBorderWidthInput: getLoginNoticeBorderWidthElement,
